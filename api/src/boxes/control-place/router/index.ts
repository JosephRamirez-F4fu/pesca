...
import {
  controlPlaceBodySchema,
  controlPlaceUpdateBodySchema,
...
export class ControlPlaceRouter {
  ...
  constructor() {
    ...
    this.router.put("/:id", validateParams(idParamSchema), validateBody(controlPlaceUpdateBodySchema), this.controller.update);
