...
import {
  otherCostTravelBodySchema,
  otherCostTravelUpdateBodySchema,
...
export class OtherCostTravelRoutes {
  ...
  constructor() {
    ...
    this.router.put("/:id", validateParams(idParamSchema), validateBody(otherCostTravelUpdateBodySchema), this.controller.update);
