...
import {
  chargerOperationCreateBodySchema,
  chargerOperationUpdateBodySchema,
...
export class ChargerOperationRoutes {
  ...
  constructor() {
    ...
    this.router.post("/", validateBody(chargerOperationCreateBodySchema), this.controller.create);
    this.router.put("/:id", validateParams(idParamSchema), validateBody(chargerOperationUpdateBodySchema), this.controller.update);
