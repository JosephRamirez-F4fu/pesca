...
import { otherCostChargerOperationBodySchema } from "../operation.schemas";
...
export class OtherCostChargerOperationRoutes {
  ...
  constructor() {
    ...
    this.router.put("/:id", validateParams(idParamSchema), validateBody(otherCostChargerOperationBodySchema), this.controller.update);
