...
import {
  vehicleRouteBalanceBodySchema,
  vehicleRouteBalanceUpdateBodySchema,
...
export class VehicleRouteBalanceRoutes {
  ...
  constructor() {
    ...
    this.router.put("/:id", validateParams(idParamSchema), validateBody(vehicleRouteBalanceUpdateBodySchema), this.controller.update);
