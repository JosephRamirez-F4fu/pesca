...
import {
  vehicleRoutesBodySchema,
  vehicleRoutesUpdateBodySchema,
...
export class VehicleRoutes {
  ...
  constructor() {
    ...
    this.router.put("/:id", validateParams(idParamSchema), validateBody(vehicleRoutesUpdateBodySchema), this.controller.update);
